          ...
          <div class="all-container">
              <div class="inner-all">
                <div class="devide-heading">
                     <span class="left-heading-word">Bạn bè</span><span class="right-legend"><i class="fa fa-plus"></i><router-link to="/addnewfriend">Thêm bạn bè</router-link></span>
                </div>
                         ...
                         <table class="table table-hover">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>31241241241</td>
                                <td>23/10/2019</td>
                                <td><button class="btn btn-danger"  @click="openModel()">xóa</button></td>
                              </tr>
                            </tbody>
                         </table>
                      </div>
